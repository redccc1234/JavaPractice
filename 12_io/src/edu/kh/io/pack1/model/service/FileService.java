...
public class FileService {
	...
	public void method1() {
		...
		// 해당 프로젝트 안에 io_test/20251014이 생성됨
		// 현재 프로젝트 : 12_io
		//					  ㄴio_test
		//						   ㄴ20251014
	...
	public void method3() {
		...
		for(File f : files) {
			...
			// 매개변수 long 값을 지정된 패턴의 형식으로 변환하여
			// 문자열 형태로 반환 메서드
			...
			// -> 만약에 폴더크기를 구하고 싶으면 폴더 안의 모든 파일을 
			//    순회하여 각 파일 크기를 합산하여 사용
			
			String result = String.format("%-20s %-20s %-10s %-5s ", fileName,date,type,size);
