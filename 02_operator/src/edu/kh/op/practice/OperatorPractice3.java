...
public class OperatorPractice3 {
	...
	public void  practice1() {
		...
		double discount = memberShip == true ? price * 0.10 : price * 0.05;
		
		double finalPrice = price - discount;
		
		System.out.printf("할인을 포함한 최종금액 : %.1f원 " , finalPrice );
	...
	public void practice2() {
		...
		int num1 = price / 50000;
		price %= 50000;
		int num2 = price / 10000;
		price %= 10000;
		int num3 = price / 5000;
		price %= 5000;
		int num4 = price / 1000;
	...
	public void practice3() {
		...
		String result = num2%num1==0 ? "배수입니다":"배수가 아닙니다";
