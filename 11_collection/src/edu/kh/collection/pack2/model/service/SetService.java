...
public class SetService {
	...
	public void method1() {
		...
		// HashSet 객체 생성
		Set<String> set  = new HashSet<>(); // 문자열만 들어오는 Set을 만듬
	 // 부모                    자식         : 다형성(업캐스팅)으로 통해서 코드 수정을 줄이는 이점
        ...
        // NullPointerException 발생하기 때문이다)
		set.add(null); 
		set.add(null);
		set.add(null);
		set.add(null);
	 ...
	 * -> int -> integer 라는 Wapper 클래스 이용하여 저장해야함
	 * TreeSet<Integer>
	 * 
