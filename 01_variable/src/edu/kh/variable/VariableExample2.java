...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		/* 자바의 기본 자료형 8가지
		 * 
		 * 논리형 : boolean (1byte) true=1,false=0
		...
		// 변수의 선언 : 메모리(RAM)의 값을 저장할 공간을 할당하는 것
		// 변수값 대입 : 변수에 값을 집어 넣는 것 (==초기화)
		...
		// 1.2345 까지만 쓰면 double 형으로 인식하기 때문에 
		// 변수 타입인 float과 일치하지 않아 Type mismatch 에러 발생
		// -> float의 리터럴표기법인  f을 붙여서 float 자료형값임을 나타냄
