...
public class ClsService /* extends Student */ {
	...
	public void ex1() {
		...
		// (default) 클래스는 같은 패키지에서만 가능
		// 다른 패키지라 import도 불가능

		// 필드 접근제한자 확인하기
		// 상속 관계에서 직접 접근 가능 범위 테스트
		// * 상속받으면 부모의 것도 마치 내 것처럼 가능*
	...
	public void ex2() {
		...
		// * static이 붙은 변수(필드)는 '클래스명.변수명'으로 사용함 *
	...
	public void ex3() {
		...
		// 문제점 : u1이 참조하고 있는 User 객체와 u2가 참조하고 있는 User객체의 필드값이 모두 동일
		// 왜? 같은 기본생성자로 USer객체를 생성하고 있기 때문에
