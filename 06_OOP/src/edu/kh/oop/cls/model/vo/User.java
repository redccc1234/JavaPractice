...
public class User {
	...
	// 기본 생성자 자동 완성 단축기 : ctrl + space -> enter
	// 기본 생성자 -> 매개변수가 없는 생성자
	...
	public User(String userId, String userPw, String userName, int userAge, char userGender) {
		...
		this(userId,userPw); // 무조건 첫번째 라인에 있어야함 
		//this.userId = userId;
		//this.userPw = userPw;
	...
	// 자바는 기본적으로 필드명,생산자명,메서드명,변수명의 중복을 허용하지 않습니다.
	...
	// [오버로딩]
	// 1) 메서드(생성자)명 동일할 것
	// 2) 매개변수의 개수, 타입(자료명), 순서 중 1개라도 달라야함
