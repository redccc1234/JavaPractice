...
public class BranchExample {
	...
	public void ex2() {
		...
		while(true) {
			...
			// next() 공백을 포함하지 않음 한 단어만 포함
			// nextLine() 공백을 포함함 다음 한 줄 포함
	...
	public void RSPGame() {
		...
		for( int i = 1 ; i <= 3 ; i++ ) {// 입력받은 판 수 만큼 반복
			System.out.println( "\n" + i + "번째 게임");
