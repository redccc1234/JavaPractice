...
public class MemberService {
	...
	public MemberService() {// 기본생성자
		...
		memberArr[1] = new Member("user02","pass02","김철수",22,"경기");
		memberArr[2] = new Member("user03","pass03","이예지",35,"강원");
	...
	public int emptyIndex() {
		...
		for(int i = 0 ; i <memberArr.length ; i++) {
			...
			// for문을 수행했지만 인덱스 값이 return되지 않은 경우
			// 해당 위치 코드가 수행된다!!
			// -> i 값을 가지고 되돌아감
			return -1;
	...
	public String signUp() {
		...
		// -> 빈자리가 있을 때 : 빈 공간의 인덱스 번호 얻어오기
		// -> 없을 때 : -1 반환 / 인덱스는 음수 값이 없어서 기준을 음수로 함
